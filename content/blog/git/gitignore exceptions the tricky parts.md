...
---
{{<img src="https://res.cloudinary.com/oorkan/image/upload/v1610149220/blog/img/topics/git/gitignore_exceptions_the_tricky_parts/banner_whseib.png" alt="gitignore exceptions - banner" loading="lazy" width="0" height="0">}}Sometimes, when pushing our changes to remote, we want to ignore everything in the directory except some files. In `.gitignore` we must use the exclamation mark **!** to do that.
